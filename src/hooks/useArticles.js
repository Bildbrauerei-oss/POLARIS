...
export function useArticles({ kategorie, sentiment, cduWirkung, handlungsbedarf, monitoringListe, limit = 100, search } = {}) {
  ...
  const fetch = useCallback(async () => {
    ...
    setCount(total || 0)
    setLoading(false)
  }, [kategorie, sentiment, cduWirkung, handlungsbedarf, monitoringListe, limit, search])
